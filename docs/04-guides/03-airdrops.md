...
Gumdrop is a program from the Metaplex community. It is currently in BETA so use at your own risk.
...
creation](/deprecated/candy-machine-js-cli/getting-started#tooling-required). 
...
2. Create a Candy Machine V2 with whitelist mint settings with mint `WLIST`
   ([Candy Machine Docs](/developer-tools/sugar/)). For example,
