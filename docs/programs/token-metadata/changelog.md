...
Version 1.2 provides security precautions and additional features. You can find the official and up-to-date changelog for this version in [the following release page](https://github.com/metaplex-foundation/metaplex-program-library/discussions/178).
